...
def status_badge(value, true_label, false_label):
    return rx.badge(
        rx.cond(value, true_label, false_label), 
        color_scheme=rx.cond(value, "green", "red")
    )
            ...
            rx.container(
                rx.vstack(
                    ...
                    rx.card(
                        rx.vstack(
                            ...
                            rx.form(
                                rx.grid(
                                    ...
                                    rx.vstack(
                                        rx.text("Fecha estimada de entrega", size="1", color_secondary=True),
                        ...
                        variant="surface", padding="1.5em", width="100%",
                    ),

                    # --- TABLA DE SEGUIMIENTO (CORREGIDA) ---
                    rx.card(
                        rx.vstack(
                            rx.hstack(
                ...
                padding_y="2em", size="4",
            ),
            width="100%", bg="#09090b", min_height="100vh",
        ),
        width="100%",
    )